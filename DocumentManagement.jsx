  ...
  return (
    <div className="document-management">
      <div className="document-header">
        <h2>ðŸ“„ Event Document Management</h2>
      </div>
      ...
      <div style={{
        ...
        ðŸ’¡ <strong>HoD:</strong> Upload one event report (PDF/DOC/DOCX) and one ZIP file for each completed event using the upload button in the Actions column.
        <br />
        ðŸ“‹ <strong>Principal:</strong> Review and approve/reject uploaded documents. Rejected documents must be re-uploaded.
      </div>
      ...
      <div className="documents-section">
        <h3>ðŸ“‹ Events & Documents ({events.length} events)</h3>
                    ...
                    <tr key={event.id} className="event-row">
                      <td className="event-details-cell">
                        ...
                        <div className="event-meta">
                          <div>ðŸ¢ {departmentName}</div>
                          <div>ðŸ“… {new Date(event.event_date).toLocaleDateString()}</div>
                          <div>ðŸ’° â‚¹{event.budget_amount?.toLocaleString()}</div>
                        </div>
                      </td>
                      
                      <td className="academic-year-cell">
                        <div className="academic-year-name">
                          ðŸŽ“ {getAcademicYearName(event.academic_year_id)}
                        </div>
                      </td>
                        ...
                        <div className="doc-action-row">
                          <div className="doc-status-inline">
                            ...
                            {reportDoc && reportDoc.status === 'rejected' && reportDoc.rejection_reason && (
                              <div className="rejection-reason-inline">âŒ {reportDoc.rejection_reason}</div>
                            )}
                          </div>
                        ...
                        <div className="doc-action-row">
                          <div className="doc-status-inline">
                            ...
                            {zipDoc && zipDoc.status === 'rejected' && zipDoc.rejection_reason && (
                              <div className="rejection-reason-inline">âŒ {zipDoc.rejection_reason}</div>
                            )}
                          </div>
        ...
        >
          ...
          >
            <div style={{
              ...
              <h3 style={{margin: 0, color: '#333'}}>ðŸ“„ Upload Report</h3>
              <button 
        ...
        >
          ...
          >
            <div style={{
              ...
              <h3 style={{margin: 0, color: '#333'}}>ðŸ“¦ Upload ZIP File</h3>
              <button 
